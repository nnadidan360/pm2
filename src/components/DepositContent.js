    ...
    return (
        ...
        <div className="col-sm-12 col-lg-12">
            ...
            <div className="card-body">
                ...
                <div>
                    <h4 className="card-title">Deposits History</h4>
                </div>
                ...
                <table className="table table-striped table-bordered no-margin">
                    ...
                    <tr className>
                        ...
                        <th className="text-center border-top-0">Amount(USD)</th>
                        <th className="text-center border-top-0">Payment mode</th>
                        <th className="text-center border-top-0">Status</th>
                        <th className="text-center border-top-0">Date Credited</th>
                    </tr>
                    </thead>
                    <tbody>
