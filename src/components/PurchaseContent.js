...
function PurchaseContent() {
    return (
            ...
            <div className="content">
             ...
             <div className="row yellow align-items-center">
  {/* <div class="col-lg-8 offset-lg-2 d-flex flex-column text-center mt-2">	
            ...
            <p class="p-0 m-0"style="color:#fff">
              Besides its privileged service, superior return, customer-centered platform features, easy and safe experience, PRIME MINNERS has the most advantageous prices in the market making mining more competative than even before. This is our way of saying "Thank You" to the ecosystem, technology, future, everyone who has the same excitement and vision as us.
            </p>
        </div> */}
  <div className="col-lg-12 d-flex flex-column text-center mt-5 mb-5">
    <div className="site-plan d-flex flex-column p-2">
      <div className="row m-0">
        ...
        <div className="col-12 p-1">
          <div className="tab-content" id="myTabContent">
            <div className="tab-pane fade active show" id="tab-btc" role="tabpanel" aria-labelledby="for-btc-tab">
              <div className="row m-0">
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Bitcoin Basic</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
                          <p>Basic</p>
                          <h1><small className="pr-2">$</small>500<small> &nbsp;-</small> 1000</h1>
                          <p>1 TH/S</p>
                        </div>
                      </div>
                      <i className="fas fa-caret-down slide-down" />
                    </div>
                    <div>
                      <div className="row min-dep mt-4 p-3 text-left">
                        <div className="col-12 pb-2 d-flex flex-column text-center">
                          <p className="all-center">15% Daily Profit</p>
                          <p className="all-center">Daily Cashout</p>
                          <p className="all-center">Money Back Guarantee</p>
                        </div>
                        <div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                          <button className="btn btn-block btn-outline-dark" type="button" data-container="body" data-trigger="focus" data-toggle="popover" data-placement="top" data-content="please ensure your account is funded.">Select</button>
                ...
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Bitcoin Pro</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
                          <p>Pro</p>
                          <h1><small className="pr-2">$</small>1000<small> &nbsp;-</small> 5000</h1>
                          <p>14 TH/s</p>
                        </div>
                      </div>
                      <i className="fas fa-caret-down slide-down" />
                    ...
                    <div>
                      <div className="row min-dep mt-4 p-3 text-left">
                        <div className="col-12 pb-2 d-flex flex-column text-center">
                          <p className="all-center">25% Daily Profit</p>
                          <p className="all-center">Daily Cashout</p>
                          <p className="all-center">Money Back Guarantee</p>
                        </div>
                        <div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                ...
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Bitcoin Standard</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
                          <p>Standard</p>
                          <h1><small className="pr-2">$</small>5000<small> &nbsp;-</small> 10000</h1>
                          <p>75 TH/s</p>
                        </div>
                      </div>
                      <i className="fas fa-caret-down slide-down" />
                    ...
                    <div>
                      <div className="row min-dep mt-4 p-3 text-left">
                        <div className="col-12 pb-2 d-flex flex-column text-center">
                          <p className="all-center">40% Daily Profit</p>
                          <p className="all-center">Daily Cashout</p>
                          <p className="all-center">Money Back Guarantee</p>
                        </div>
                        <div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
            ...
            <div className="tab-pane fade" id="tab-eth" role="tabpanel" aria-labelledby="for-eth-tab">
              <div className="row m-0">
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Ethereum Basic</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
                          <p>Basic</p>
                          <h1><small className="pr-2">$</small>100<small> &nbsp;-</small> 500</h1>                                                          
                          <p>6 MH/s</p>
                        </div>
                      </div>
                      <i className="fas fa-caret-down slide-down" />
                ...
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Ethereum Pro</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
                    ...
                    <div>
                      <div className="row min-dep mt-4 p-3 text-left">
                        <div className="col-12 pb-2 d-flex flex-column text-center">
                          <p className="all-center">25% Daily Returns</p>
                          <p className="all-center">Daily Cashout</p>
                          <p className="all-center">Money Back Guarantee</p>
                        </div>
                        <div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                ...
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Ethereum Standard</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
                    ...
                    <div>
                      <div className="row min-dep mt-4 p-3 text-left">
                        <div className="col-12 pb-2 d-flex flex-column text-center">
                          <p className="all-center">40% Daily Returns</p>
                          <p className="all-center">Daily Cashout</p>
                          <p className="all-center">Money Back Guarantee</p>
                        </div>
                        <div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
            ...
            <div className="tab-pane fade" id="tab-ltc" role="tabpanel" aria-labelledby="for-ltc-tab">
              <div className="row m-0">
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Litecoin Basic</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
                    ...
                    <div>
                      <div className="row min-dep mt-4 p-3 text-left">
                        <div className="col-12 pb-2 d-flex flex-column text-center">
                          <p className="all-center">15% Daily Returns</p>
                          <p className="all-center">Daily Cashout</p>
                          <p className="all-center">Money Back Guarantee</p>
                        </div>
                        <div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                ...
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Litecoin Pro</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
                ...
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Litecoin Standard</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
                    ...
                    <div>
                      <div className="row min-dep mt-4 p-3 text-left">
                        <div className="col-12 pb-2 d-flex flex-column text-center">
                          <p className="all-center">40% Daily Return</p>
                          <p className="all-center">Daily Cashout</p>
                          <p className="all-center">Money Back Guarantee</p>
                        </div>
                        <div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
            ...
            <div className="tab-pane fade" id="tab-bch" role="tabpanel" aria-labelledby="for-bch-tab">
              <div className="row m-0">
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Dash Basic</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
                ...
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Dash Pro</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
                ...
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Dash Standard</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
            ...
            <div className="tab-pane fade" id="tab-dash" role="tabpanel" aria-labelledby="for-dash-tab">
              <div className="row m-0">
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Doge Basic</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
                ...
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Doge Pro</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
                ...
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Doge Standard</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
            ...
            <div className="tab-pane fade" id="tab-doge" role="tabpanel" aria-labelledby="for-doge-tab">
              <div className="row m-0">
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Zcash Basic</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
                ...
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Zcash Pro</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
                ...
                <div className="col-lg-4 d-flex flex-column p-2">
                  <div className="d-flex flex-column white-bo">
                    <div>
                      <h4 className="m-0 p-4 d-flex text-center all-center">Zcash Standard</h4>
                    </div>
                    <div className="bo-box d-flex all-center p-4">
                      <div className="row flex-fill">
                        <div className="col-12 d-flex flex-column all-center">
