    ...
    <main style={{background:"#141414"}}>
                    ...
                    <div class="container ">
                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-lg-8 text-center d-flex flex-column pb-0 pt-5">
                                    <div class="mb-4">
                                        <span class="sub-title-text" style={{color:"#fff"}}>Hash Power = Your Strength</span>
                                    </div>
                                    <h1 class="omgd3" style={{fontSize:"30px", color:"#fd961a"}}>There Are Things You Can Not Buy With Money.</h1>
                                    <h1 class="omgd3" style={{paddingTop:"10px", color:"#fd961a"}}><b> Hash Power Ain't One Of Them.</b></h1>

                                    <p class="pb-0 m-0 pt-4" style={{color:"#fff"}}>
                                        PRIME Minners provides its users with an effortless cryptocurrency mining experience by operating state-of-the-art mining devices by experts in sheltered facilities. It differs from its competitors with its international operative capacity, numerous patents and research, the contribution of respected managers and experienced team, user-oriented thinking structure and investments in technology. With these features, it can offer the most affordable prices in the market without requiring additional commissions or additional fees.
                                    </p>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 pb-4">
                                <div class="pr-lg-5">
                                    ...
                                    <h1 class="pb-3" style={{color:"#fff"}}>The New Standard Of <b>Crypto Mining.</b></h1>
                                    <p class="pb-2" style={{color:"#fff"}}>
                                        Our goal is to create a fair mining environment. We imagine an ecosystem that opens its doors to anyone who wants to be involved without technical and market know-how. This was our basic motivation, while combining the most essential features in the most compact and understandable way. Get involved in just three stages; observe your returns on your platform wallet on daily basis.
                                    </p>
                                    <div>
                            ...
                            <div class="col-lg-6 offset-lg-1 d-flex flex-column justify-content-center">
                                ...
                                <div class="d-flex aff-list">
                                    ...
                                    <div class="pr-5">
                                        <h6 class="pb-0" style={{color:"#fff"}}>Create An Account.</h6>
                                ...
                                <div class="d-flex aff-list">
                                    ...
                                    <div class="pr-5">
                                        <h6 class="pb-0" style={{color:"#fff"}}>Choose Coins To Mine.</h6>
                                        <p class="mb-0" style={{color:"#fff"}}>
                Choose mining algorithm and available coins and start investing. Feel free to distribute your hash powe on plenty of coins.
                                ...
                                <div class="d-flex aff-list">
                                    ...
                                    <div class="pr-5">
                                        <h6 class="pb-0" style={{color:"#fff"}}>Accumulate Weekly Return.</h6>
                                        <p class="mb-0" style={{color:"#fff"}}>
