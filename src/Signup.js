...
function Signup() {
    return (
        ...
        // <div style={{marginTop:"150px", marginBottom:"30px", background:"#141414", zIndex:"100"}}>
      ...
      <div className="card p-4">
        <div className="card-body">
          ...
          <div className="input-group mb-3">
            ...
            <div className="row">
              <div className="col-6">
                <button type="submit" name="register" className="btn btn-warning px-4">Register</button>
              </div>
